\section{Processi di Supporto}
	...
	\subsection{Gestione della configurazione}
		...
		\subsubsection{Versionamento}
			...
			Il repository per la documentazione è organizzato nel seguente modo:
			\begin{itemize}
			...
			\myparagraph{Repository per il codice}
			...
			\end{center}
				...
				\begin{itemize}
					\item \textbf{.github/workflows}: è la cartella contenente i file di configurazione per la realizzazione della \glo{Continuous Integration}
	...
	\subsection{Gestione della Qualità}
		...
		Il \glo{code refactoring} è il processo di ristrutturazione di codice esistente che va ad influire sulla struttura piuttosto che sul comportamento. Il code refactoring si concentra sulla
