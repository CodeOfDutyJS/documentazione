\section{Processi Primari}
	...
	\subsection{Sviluppo}
		...
		\subsubsection{Attività}
			...
			\begin{itemize}
			    \item \textbf{Qualità di processo}: vengono carcati negli standard i processi da attuare, individuati degli obiettivi di qualità e le metriche corrispondenti, vengono stilati metodi per perseguire gli obiettivi posti;
			    \item \textbf{Qualità di prodotto}: vengono identificate delle metriche corrispondenti agli attributi del prodotto e definiti degli obiettivi di qualità;
