	...
	\subsection{Gestione Organizzativa}
		...
		Vengono di seguito riportare le procedure che il collettivo adotterà durante la realizzazione del progetto. Le comunicazioni potranno essere interne(tra i membri del collettivo) oppure esterne (oltre ai membri del collettivo vi sono anche proponente e committente).
			...
			\paragraph{Gestione degli incontri}
				...
				\begin{itemize}
					\textbf{V}: indica un verbale
					\textbf{I}: indica che si tratta di un verbale interno
					\textbf{X}: indica il numero di verbale interno (numerazione progressiva)
					\textbf{YY}: individua una decisione all'interno del verbale(numerazione progressiva).
				\end{itemize}
				...
				\begin{itemize}
					\textbf{V}: indica un verbale
					\textbf{E}: indica che si tratta di un verbale esterno
					\textbf{X}: indica il numero di verbale esterno (numerazione progressiva)
					\textbf{YY}}: individua una decisione all'interno del verbale esterno (numerazione progressiva).
				\end{itemize}
		...
		\begin{itemize}
			...
			\item \textbf{GitHub}: utilizzato per il versionamento ed il salvataggio in remoto di tutti i file che riguardano il progetto;
