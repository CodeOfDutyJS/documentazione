...
\def\problems{
    {
        ...
        Grazie al supporto dei canali di comunicazione individuati dalle \noexpand\textit{Norme di Progetto 3.0.0} e all'attività di verbalizzazione non è necessario che sia presente l'intero team ogni incontro. Per gli incontri più importanti{,} dove è necessario che sia presente tutto il gruppo{,} è necessario mettersi d'accordo con largo anticipo.,
        \noexpand\textbf{Ultimo aggiornamento:} RQ \noexpand\newline
    ...
    },
    {
        RO1-1,
        \noexpand\textbf{Prima rilevazione:} RA \noexpand\newline
        Il ruolo di amministratore ha richiesto più ore rispetto a quanto preventivato{,} come riportato nel \noexpand\textit{Piano di Progetto 3.0.0} {,} è stato dedicato molto tempo a impostare la repository e le Github Actions{,} con l'obiettivo di automatizzare il più possibile alcune operazioni.,
    ...
    },
    {
        ...
        \noexpand\textbf{Prima rilevazione:} RQ \noexpand\newline
