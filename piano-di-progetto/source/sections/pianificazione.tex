\section{Pianificazione}
	...
	\end{itemize}
	\noindent Nella tabella degli incrementi sono anche segnate le ore che saranno dedicate a ciascun incremento, per un totale di 181 ore come preventivato nella \textit{\hyperref[table:nuovo_orario_verifica]{tabella della nuova pianificazione}} presentata successivamente alla fase di progettazione di dettaglio e codifica.
	...
	\subsubsection{Diagramma}
		\begin{figure}[H]
    		...
    		\end{figure}
	\subsubsection{Tabella incrementi}
	\label{table:pianificazione_verifica}
	\begin{longtabu} to \textwidth{| X[0.2, c m] | X[0.4, l m ] |}
		\hline
		\textbf{Nome} & \textbf{Descrizione} \\ 
	 \hline
