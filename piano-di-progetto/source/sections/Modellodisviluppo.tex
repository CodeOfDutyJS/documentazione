...
Il gruppo \textit{Code of Duty} ha scelto di utilizzare il modello incrementale come modello di sviluppo per la produzione del software \hd .
\subsection{Modello incrementale}
Il modello incrementale è un modello di sviluppo di progetto basato sulla successione dei seguenti passi principali:
\begin{itemize}
	\item Pianificazione;
