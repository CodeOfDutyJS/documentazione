...
Sono stati determinati, come descritto anche nel documento \textit{Norme di Progetto 3.0.0}, 5 tipi di test ovvero: 
...
Per rispettare i requisiti identificati nel documento \textit{Analisi dei Requisiti 3.0.0} e per garantire il funzionamento del prodotto si eseguono i seguenti Test di sistema:\\
...
\subsubsection{Test di sistema per i requisiti funzionali}
    ...
    {   
        ...
        \end{itemize}},
        NI,
        RFF6.1 RFF6.1.1 RFF6.1.2 6.1.3
    },
    {   
        TSOF7,
