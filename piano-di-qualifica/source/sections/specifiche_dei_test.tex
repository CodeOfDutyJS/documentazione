...
\subsubsection{Test di sistema per i requisiti funzionali}
    ...
    {   
        TSOF1,
        Si verifica che l'utente possa caricare i propri dati per la visualizzazione: tramite una tabella di un database e tramite file CSV,
        NI,
        RF01 RFO1.1 RFO1.2
    },
    {   
        TSOF1.3,
        Si verifica che sia visualizzato un messaggio di errore se il caricamento dei dati fallisce,
        NI,
        RFO1.3
    },
     {   
