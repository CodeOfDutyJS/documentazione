...
Durante questo periodo il progetto didattico a preso forma. In particolare il guppo ha posto l'accento sulla concretizzazione della product baseline, quindi dei design pattern, classi e attività necessarie alla codifica.
...
Una fonte di rischio di bassa qualità potrebbe essere il valore insufficiente di alcnune metriche. Le metriche che hanno avuto un'esito insufficiente ovvero la percentuale dei requisiti soddisfatti, il code coverage e la facilità di comprensione del codice, saranno migliorate
