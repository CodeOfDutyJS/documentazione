...
\begin{longtabu} to \textwidth {| X[0.1,c m] | X[0.1,c m] | X[0.1,c m] | X[0.1,c m]|}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=5 cm]{source/sections/images/TB.JPG}
        \caption{Grafico dei valori del Budget at completion}
    \end{figure}
...
\begin{longtabu} to \textwidth {| X[0.1,c m] | X[0.1,c m] | X[0.1,c m] | X[0.1,c m]|}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=10 cm]{source/sections/images/TB.JPG}
