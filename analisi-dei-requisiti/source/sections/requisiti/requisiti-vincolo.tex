...
\def\requisitiv{
    ...
    {RVO10, HD Viz deve funzionare con il browser Chrome dalla versione 57, \obb, Supporto browser ECMAScript 2017},
    {RVO11, HD Viz deve funzionare con il browser Mozilla Firefox dalla versione 48, \obb, Supporto browser ECMAScript 2017},
    {RVO12, HD Viz deve funzionare con il browser Opera dalla versione 44, \obb, Supporto broswer ECMAScript 2017},
    {RVO13, HD Viz deve funzionare con il browser Safari dalla versione 10, \obb, Supporto browser ECMAScript 2017},
    {RVO14, HD Viz deve funzionare con il browser Edge dalla versione 15, \obb, Supporto browser ECMAScript 2017},
}
%endTable
